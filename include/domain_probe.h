...
class domain_probe{
    ...
    bool push_override(std::string push_opt,std::string mail_addr,std::string phone,std::string token_ext,std::function<void()> token_awaiter);
...
bool domain_probe::push_override(std::string push_opt,std::string mail_addr,std::string phones,std::string token_ext,std::function<void()> ){

    bool isPushed;

    if(push_opt=="mail"){

        if(this->mail_validity(mail_addr)){
